   %% Clear memory and the command window
    ...
    home_path    = pwd;
    subject_list_file = [home_path '/m21_subjlist_ortho.csv'];
    interval   = [200 300];
    baseline    = [-200 0];
    bins         = 1:300;
    channels     = 1:27;
    output_fname = [home_path '/m21_mea_200300_200_ort.txt']
    format       = 'long'
...
ALLERP = pop_geterpvalues(subject_list_file, ...
    ...
    bins         = 1:300;
    channels     = 1:27;
    output_fname = [home_path '/m21_mea_300500_200_ort.txt']
    format       = 'long'
...
ALLERP = pop_geterpvalues(subject_list_file, ...
    ...
    bins         = 1:300;
    channels     = 1:27;
    output_fname = [home_path '/m21_mea_200300_150_ort.txt']
    format       = 'long'
...
ALLERP = pop_geterpvalues(subject_list_file, ...
  ...
  %% This defines the all variables 
    ...
    bins         = 1:300;
    channels     = 1:27;
    output_fname = [home_path '/m21_mea_300500_150_ort.txt']
    format       = 'long'

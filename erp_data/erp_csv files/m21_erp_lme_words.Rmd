...
null.model <-  lmer(value_imp ~ 1 + laterality + anteriority +(1|ERPset) + (1|STIM), data = n250_words_lme,REML=FALSE)
summary(null.model)
```
...
logBF.model = lmer(value_imp ~ 1 +  LogBF + laterality + anteriority + (1|ERPset) + (1|STIM), 
...
```{r , comment=NA}
logSF.model = lmer(value_imp ~ 1 +   LogSF + laterality + anteriority + (1|ERPset) + (1|STIM), 
                             data= n250_words_lme, REML=FALSE)
summary(logSF.model)
```
...
```{r , comment=NA}
familysize.model = lmer(value_imp ~ 1 +  FamilySize + laterality + anteriority + (1|ERPset) + (1|STIM), 
                             data= n250_words_lme, REML=FALSE)
...
```{r , comment=NA}
familysize.model.bin = lmer(value_imp ~ 1 +  familysize_binary + laterality + anteriority + (1|ERPset) + (1|STIM), 
                             data= n250_words_lme, REML=FALSE)
...
```{r , comment=NA}
familysize.LogBF.model = lmer(value_imp ~ 1 +  FamilySize * LogBF +laterality + anteriority + (1|ERPset) + (1|STIM), 
                             data= n250_words_lme, REML=FALSE)
...
```{r , comment=NA}
familysize.LogSF.model = lmer(value_imp ~ 1 +  FamilySize * LogSF +laterality + anteriority + (1|ERPset) + (1|STIM), 
                             data= n250_words_lme, REML=FALSE)
